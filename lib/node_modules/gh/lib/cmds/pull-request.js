...
PullRequest.prototype.run = function() {
    ...
    // what about a handler for every cmd?
    // var availableMethods = ['browser', 'list', 'close', 'comment', 'fetch'] ...
    // invoke for every key on the list
    // take care about options.merge || options.rebase...
    ...
    if (!options.pullBranch && (options.close || options.fetch || options.merge)) {
        console.error('You\'ve invoked a method that requires an issue number.');
    }
...
PullRequest.prototype._fwdHandler = function() {
    ...
    hooks.invoke('pull-request.fwd', instance, function(afterHooksCallback) {
        logger.logTemplate(
            'Forwarding pull request {{greenBright "#" options.number}} to {{{magentaBright "@" options.fwd}}}', {
                options: options
            });
        ...
        instance.forward(function(err, pull) {
            ...
            logger.logTemplate('{{forwardedLink}}', {
                options: options
            });
...
PullRequest.prototype._closeHandler = function() {
    ...
    hooks.invoke('pull-request.close', instance, function(afterHooksCallback) {
        logger.logTemplate(
            'Closing pull request {{greenBright "#" options.number}}', {
                options: options
            });
...
PullRequest.prototype._commentHandler = function() {
    ...
    logger.logTemplate('Adding comment on pull request {{greenBright "#" options.number}}', {
        options: options
    });
...
PullRequest.prototype._listHandler = function() {
    ...
    if (options.all) {
        logger.logTemplate(
            'Listing all {{options.state}} pull requests for {{#if options.org}}{{greenBright options.org}}{{else}}{{greenBright options.user}}{{/if}}', {
                options: options
            });
        ...
        if (options.me) {
            logger.logTemplate(
                'Listing {{options.state}} pull requests sent by {{greenBright options.loggedUser}} on {{greenBright options.user "/" options.repo}}', {
                    options: options
                });
        }
        else {
            logger.logTemplate(
                'Listing {{options.state}} pull requests on {{greenBright options.user "/" options.repo}}', {
                    options: options
                });
        }
...
PullRequest.prototype._openHandler = function() {
    ...
    hooks.invoke('pull-request.open', instance, function(afterHooksCallback) {
        logger.logTemplate(
            'Opening pull request {{greenBright "#" options.number}}', {
                options: options
            });
...
PullRequest.prototype._submitHandler = function() {
    ...
    hooks.invoke('pull-request.submit', instance, function(afterHooksCallback) {
        logger.logTemplate(
            'Submitting pull request to {{{magentaBright "@" options.submit}}}', {
                options: options
            });
        ...
        instance.submit(options.submit, function(err, pull) {
            ...
            logger.logTemplate('{{submittedLink}}', {
                options: options
            });
